...
$query = "SELECT professor_nome, aluno_nome, status_aluno, data_aula, hora_aula, tempo_aula, livro, pagina, temafree, free_talk, ultima_atividade, homework, old_homework, new_homework, descricao_homework, mensagem_pais_alunos, mensagem_professores, created_at 
                                        ...
                                        <?php if ($result->num_rows > 0): ?>
                                            <?php while ($row = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row['status_aluno']); ?></td>
                                                    <td>
                                                        <?php 
                                                    ...
                                                    <td><?php echo htmlspecialchars($row['tempo_aula']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['livro']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['pagina']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['ultima_atividade']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['free_talk']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['old_homework']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['new_homework']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['descricao_homework']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['mensagem_professores']); ?></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr>
