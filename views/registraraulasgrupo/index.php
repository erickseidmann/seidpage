...
<?php for ($i = 1; $i <= 5; $i++): ?>
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h5 class="mbr-fonts-style display-7">Aluno <?php echo $i; ?></h5>
            <!-- Campo de Nome do Aluno -->
            <div class="form-group">
                <label for="nome_aluno<?php echo $i; ?>">Nome do Aluno <?php echo $i; ?>:</label>
                <input list="alunos-list" name="nome_aluno<?php echo $i; ?>" id="nome_aluno<?php echo $i; ?>" class="form-control" placeholder="Selecione ou digite o aluno" >
                <datalist id="alunos-list">
                    <?php foreach ($alunos as $aluno): ?>
                        <option value="<?php echo htmlspecialchars($aluno['name']); ?>">
                    <?php endforeach; ?>
                </datalist>
            </div>

            <!-- Campo de Status do Aluno -->
            <div class="form-group">
                <label for="status_aluno<?php echo $i; ?>">Status do Aluno <?php echo $i; ?>:</label>
                <select name="status_aluno<?php echo $i; ?>" id="status_aluno<?php echo $i; ?>" class="form-control" >
...
<input type="text" name="temafree" placeholder="Descreva o tema principal" data-form-field="text1" class="form-control display-7" required="required" value="" id="temafree">
</div>
<div data-for="textarea" class="col-lg-12 col-md-12 col-sm-12 form-group">
<textarea name="free_talk" placeholder="Adicione o conteúdo trabalhado no free talk" data-form-field="textarea" class="form-control display-7" required="required" id="free_talk"></textarea>
</div>
<div class="col-lg-12 col-md-12 col-sm-12">
<hr>
</div>
