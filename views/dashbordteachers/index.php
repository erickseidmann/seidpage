...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=NIXyv9"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=NIXyv9" type="text/css">
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-uu6mk83nqw" once="menu" id="menu01-u">
...
<section data-bs-version="5.1" class="header1 cid-uu6mkeYlUr" id="header01-v">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-12">
                ...
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Aulas de ingles&nbsp;</strong><br><strong>Personalizadas para voce!</strong><br><br></h1>
...
<section data-bs-version="5.1" class="article1 cid-uu6mkfWyZE mbr-fullscreen mbr-parallax-background" id="article01-w">
...
<section data-bs-version="5.1" class="slider1 mbr-embla cid-uu6mkgUBLW" id="features04-x">
        ...
        <div class="position-relative row text-center">
            <div class="col-lg-4">
                <div class="mbr-section-head p-4">
                    <h4 class="mbr-section-title mbr-fonts-style align-left mb-0 display-1"><strong>Nossos</strong><br><div><strong>Cursos</strong></div>
                    </h4>
                        ...
                        <div class="embla__container">
                            <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                                <div class="slide-content">
                                    ...
                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-2">Inglês<br>English<br></h6>
                                    <div class="item-wrapper">

                                        <div class="item-img">
                                            <img src="assets/images/mbr-727x383.png" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                                <div class="slide-content">
                                    ...
                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-2">
                                        Espanhol
                                        <div>Spanish</div>
                                    </h6>
                                    <div class="item-wrapper">
                                        ...
                                        <div class="item-img">
                                            <img src="assets/images/mbr-1-742x557.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="item-content">
...
<section data-bs-version="5.1" class="features1 cid-uu6mkhYFmF" id="features01-y">
...
<section data-bs-version="5.1" class="features1 cid-uu6mkj4B7o" id="features01-z">
...
<section data-bs-version="5.1" class="features1 cid-uu6mkk3Vcc" id="features01-10">
...
<section data-bs-version="5.1" class="list1 cid-uu6mkldJ8u" id="list01-11">
...
<section data-bs-version="5.1" class="header5 cid-uu6mkmcNBD" id="header05-12">
...
<section data-bs-version="5.1" class="clients2 cid-uu6mknbLVm" id="people02-13">
...
<section data-bs-version="5.1" class="people4 cid-uu6mkoavd9" id="people04-14">
...
<section data-bs-version="5.1" class="contacts1 cid-uu6mkpm3IM" id="contacts01-15">
...
<section data-bs-version="5.1" class="form cid-uu6mkqI0d8" id="form01-16">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 mx-auto mbr-form" data-form-type="formoid">
                <!--Formbuilder Form-->
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="E3PMFKXyXKPm54KW4kPKwc+i/9MifaiKyIkY63393mxzmcJLm4ZXQFXewjGKk0ZSqFGj5XPnDLjS72l6VJmmZA2DAgXqzfvUHwtOWgjzNXk1LJz3VDo8eQdzQ70lOJdT.CnzR8ZFSD3yxqq+Hr4CWN60cIzTxiGZnKCJMZr1fiJv8sAWQIpCFH2+HkZ7DX47GId3qL2Oeg35XbxnjvlF4hA47Aozrt6tdOMU88P9Sn3gXngsm70wZHZKTIjc7NLdo">
                    <div class="row">
                    ...
                    <div class="dragArea row">
                        <div class="col-lg-6 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <input type="text" name="name" placeholder="Name" data-form-field="name" class="form-control display-7" value="" id="name-form01-16">
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 form-group mb-3" data-for="email">
                            <input type="email" name="email" placeholder="Email" data-form-field="email" class="form-control display-7" value="" id="email-form01-16">
                        </div>
                        <div data-for="phone" class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                            <input type="tel" name="phone" placeholder="Phone" data-form-field="phone" class="form-control display-7" pattern="*" value="" id="phone-form01-16">
                        </div>
                        <div data-for="message" class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                            <textarea name="message" placeholder="Message" data-form-field="message" class="form-control display-7" id="message-form01-16"></textarea>
                        </div>
...
<section data-bs-version="5.1" class="footer2 cid-uu6mkt1jSP" id="footer02-18">
